...
| **`figure/`** | All figure plotting scripts (16 scripts, Figures 2–6), including public-reproducibility variants |
...
| 5 | `figure5.py` / `figure5_public.py` | 6-city 3D 2x2 bivariate maps |
...
| fig2-1 | `fig2-1地图-建筑气候区划.py` | China building climate zone reference map |

**Figures 2-c, 2-d, 5**: `figureX.py` reads private SHP data (author use); `figureX_public.py` reads pre-computed GeoJSON grid data (public reproducibility).
